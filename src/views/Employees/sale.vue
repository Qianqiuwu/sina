  ...
  <div class="content">
    ...
    <div class="same-tabl">
      ...
      >
        ...
        <el-table-column label="供货数量" width="160">
          <template slot-scope="scope">
            <span style="margin-left: 10px">{{
  ...
  methods: {
    ...
    Edit(id) {
      ...
      this.axios({
        ...
        this.getprname(data.data.product_name)
    ...
    getprname(values) {
      this.axios({
        ...
        this.ruleForm.sales_price = data.data.sales_price
        this.Inventoryss = Number(data.data.Inventory)
      })
    },
    // 初始数据获取当前管理员的信息数据
    getactivity() {
